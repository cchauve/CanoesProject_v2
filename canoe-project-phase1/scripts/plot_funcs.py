...
def plot_canoe(width, height, length, corner_radius, type):
    ...
    """
    checks if there is something wrong with the input
    """
    ...
    min_range=(-max_range)
    """
    eta and theta are numbers used to make 3D figure of the canoe
    define fig to be a variable storing datas to make the figure
    get_coordinates() will give 3D coordinates of the canoe
    go.Surface() makes the 3D figure using the given 3D coordinates
    add_trace() will allow us to update the figure later on
    """
    ...
    """
    make a slider for 4 variables. Each slider slides by 0.1, 
    we calculate coordinates for new figure as slider slides, and show that figure
    """
